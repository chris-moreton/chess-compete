...
DEFAULT_PARAMS = {
    ...
    'probcut_margin': {'value': 50, 'min': 50, 'max': 250, 'step': 15, 'group': 'reductions-extensions'},
    'probcut_depth_reduction': {'value': 5, 'min': 2, 'max': 8, 'step': 1, 'group': 'reductions-extensions'},
    'multicut_min_depth': {'value': 19, 'min': 12, 'max': 28, 'step': 1, 'group': 'reductions-extensions'},
    'multicut_depth_reduction': {'value': 10, 'min': 3, 'max': 12, 'step': 1, 'group': 'reductions-extensions'},
    'multicut_moves_to_try': {'value': 14, 'min': 4, 'max': 16, 'step': 1, 'group': 'reductions-extensions'},
    ...
    'threat_extension_margin': {'value': 398, 'min': 100, 'max': 800, 'step': 50, 'group': 'reductions-extensions'},
    # ==================== move-ordering ====================
