...
DEFAULT_PARAMS = {
    ...
    'lmr_continuation_good_threshold': {'value': 8487, 'min': 2000, 'max': 15000, 'step': 500, 'group': 'reductions-extensions'},
    'lmr_continuation_bad_threshold': {'value': -8726, 'min': -15000, 'max': -2000, 'step': 500, 'group': 'reductions-extensions'},
    'probcut_min_depth': {'value': 11, 'min': 8, 'max': 20, 'step': 1, 'group': 'reductions-extensions'},
    'probcut_margin': {'value': 39, 'min': 50, 'max': 250, 'step': 15, 'group': 'reductions-extensions'},
    'probcut_depth_reduction': {'value': 4, 'min': 2, 'max': 8, 'step': 1, 'group': 'reductions-extensions'},
    'multicut_min_depth': {'value': 19, 'min': 12, 'max': 28, 'step': 1, 'group': 'reductions-extensions'},
    'multicut_depth_reduction': {'value': 9, 'min': 3, 'max': 12, 'step': 1, 'group': 'reductions-extensions'},
    'multicut_moves_to_try': {'value': 13, 'min': 4, 'max': 16, 'step': 1, 'group': 'reductions-extensions'},
    'multicut_required_cutoffs': {'value': 6, 'min': 3, 'max': 12, 'step': 1, 'group': 'reductions-extensions'},
    'singular_extension_min_depth': {'value': 13, 'min': 6, 'max': 16, 'step': 1, 'group': 'reductions-extensions'},
    'singular_extension_depth_margin': {'value': 5, 'min': 2, 'max': 10, 'step': 1, 'group': 'reductions-extensions'},
    ...
    'threat_extension_margin': {'value': 449, 'min': 100, 'max': 800, 'step': 50, 'group': 'reductions-extensions'},
    # ==================== move-ordering ====================
    ...
    # ==================== king-play (SPSA tuned, Run 12) ====================
    'king_threat_bonus_knight': {'value': 10, 'min': 4, 'max': 40, 'step': 4, 'group': 'king-play'},
    'king_threat_bonus_queen': {'value': 14, 'min': 4, 'max': 40, 'step': 4, 'group': 'king-play'},
    'king_threat_bonus_bishop': {'value': 12, 'min': 4, 'max': 40, 'step': 4, 'group': 'king-play'},
    'king_threat_bonus_rook': {'value': 9, 'min': 2, 'max': 30, 'step': 3, 'group': 'king-play'},
    'value_king_attacks_minor': {'value': 28, 'min': 5, 'max': 50, 'step': 5, 'group': 'king-play'},
    'value_king_attacks_rook': {'value': 9, 'min': 3, 'max': 40, 'step': 4, 'group': 'king-play'},
    'value_king_mobility': {'value': 9, 'min': 1, 'max': 20, 'step': 2, 'group': 'king-play'},
    'value_king_cannot_catch_pawn': {'value': 418, 'min': 200, 'max': 800, 'step': 40, 'group': 'king-play'},
    'value_king_cannot_catch_pawn_pieces_remain': {'value': 425, 'min': 200, 'max': 800, 'step': 40, 'group': 'king-play'},
    'value_king_distance_passed_pawn_multiplier': {'value': 2, 'min': 1, 'max': 10, 'step': 1, 'group': 'king-play'},
    'value_king_supports_passed_pawn': {'value': 6, 'min': 1, 'max': 10, 'step': 1, 'group': 'king-play'},
    # ==================== passed-pawns (SPSA tuned, Run 12) ====================
    'passed_pawn_bonus_rank2': {'value': 18, 'min': 5, 'max': 50, 'step': 5, 'group': 'passed-pawns'},
    'passed_pawn_bonus_rank3': {'value': 14, 'min': 5, 'max': 55, 'step': 5, 'group': 'passed-pawns'},
    'passed_pawn_bonus_rank4': {'value': 14, 'min': 10, 'max': 65, 'step': 6, 'group': 'passed-pawns'},
    'passed_pawn_bonus_rank5': {'value': 39, 'min': 15, 'max': 80, 'step': 7, 'group': 'passed-pawns'},
    'passed_pawn_bonus_rank6': {'value': 70, 'min': 20, 'max': 100, 'step': 8, 'group': 'passed-pawns'},
    'passed_pawn_bonus_rank7': {'value': 88, 'min': 25, 'max': 120, 'step': 10, 'group': 'passed-pawns'},
    'connected_passed_pawn_rank2': {'value': 10, 'min': 2, 'max': 30, 'step': 3, 'group': 'passed-pawns'},
    'connected_passed_pawn_rank3': {'value': 22, 'min': 5, 'max': 40, 'step': 4, 'group': 'passed-pawns'},
    'connected_passed_pawn_rank4': {'value': 27, 'min': 10, 'max': 60, 'step': 5, 'group': 'passed-pawns'},
    'connected_passed_pawn_rank5': {'value': 39, 'min': 15, 'max': 80, 'step': 7, 'group': 'passed-pawns'},
    'connected_passed_pawn_rank6': {'value': 76, 'min': 25, 'max': 120, 'step': 10, 'group': 'passed-pawns'},
